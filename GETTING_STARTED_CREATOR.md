...
> **⚠️ NOTE:** This file is preserved for reference but may be outdated.
>
> **For current documentation**, see:
> - [claude-code-skill-creator/README.md](claude-code-skill-creator/README.md) - Main creator tool documentation
